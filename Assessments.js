...
function createActivityAssessmentHTML_(students, grade, classNo, year, school, director, teacherName, logoBase64) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"><style>'
    + '@page{size:A4;margin:1cm 1cm}*{-webkit-print-color-adjust:exact;print-color-adjust:exact}body{font-family:"Sarabun",sans-serif;font-size:11pt;font-weight:300;line-height:1.2;color:#000;margin:0;padding:0}.header{text-align:center;margin-bottom:8px}.logo{width:50px;height:50px;object-fit:contain;margin-bottom:5px}.title{font-size:14pt;font-weight:700;margin-bottom:3px}.subtitle{font-size:12pt;font-weight:600}.info-box{text-align:center;margin-bottom:10px;font-size:12pt;font-weight:400}table{width:100%;table-layout:fixed;border-collapse:collapse;margin-bottom:8px;max-width:100%}th,td{border:1px solid #000;padding:4px 3px;font-size:10pt;font-weight:300;vertical-align:middle;overflow:hidden;word-wrap:break-word}th{background-color:#f0f0f0;color:#000;font-weight:700;height:30px}.center{text-align:center}.left{text-align:left;padding-left:5px}.font-bold{font-weight:600}.name-cell{font-size:9pt;word-break:break-word}'
    + '.summary-inline{margin:10px 0;padding:8px 15px;border:2px solid #000;text-align:center;font-size:10pt}.summary-inline .value{font-weight:700;font-size:12pt;margin:0 3px}.legend-inline{margin:8px 0;font-size:9pt;text-align:center}'
