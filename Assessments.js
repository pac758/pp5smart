...
function createActivityAssessmentHTML_(students, grade, classNo, year, school, director, teacherName, logoBase64) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"><link href="https://fonts.googleapis.com/css2?family=Sarabun:wght@400;500;600;700&display=swap" rel="stylesheet"><style>'
    + '@page{size:A4;margin:1cm 1cm}body{font-family:"Sarabun",sans-serif;font-size:11pt;font-weight:300;line-height:1.2;color:#000;margin:0;padding:0}.header{text-align:center;margin-bottom:8px}.logo{width:50px;height:50px;object-fit:contain;margin-bottom:5px}.title{font-size:14pt;font-weight:700;margin-bottom:3px}.subtitle{font-size:12pt;font-weight:600}.info-box{text-align:center;margin-bottom:10px;font-size:12pt;font-weight:400}table{width:100%;table-layout:fixed;border-collapse:collapse;margin-bottom:8px;max-width:100%}th,td{border:1px solid #000;padding:4px 3px;font-size:10pt;font-weight:300;vertical-align:middle;overflow:hidden;word-wrap:break-word}th{background-color:#333;color:#fff;font-weight:700;height:30px}.center{text-align:center}.left{text-align:left;padding-left:5px}.font-bold{font-weight:600}.name-cell{font-size:9pt;word-break:break-word}.pass{color:#000!important}.not-pass{color:#dc3545!important}'
    ...
    + '<table><thead><tr><th style="width:4%;background-color:#333;color:#fff">ที่</th><th style="width:28%;background-color:#333;color:#fff">ชื่อ - นามสกุล</th><th style="width:11%;background-color:#333;color:#fff">แนะแนว</th><th style="width:13%;background-color:#333;color:#fff">ลูกเสือ/เนตรนารี</th><th style="width:11%;background-color:#333;color:#fff">ชุมนุม</th><th style="width:12%;background-color:#333;color:#fff">เพื่อสังคมฯ</th><th style="width:10%;background-color:#333;color:#fff">สรุปผล</th></tr></thead><tbody>' + rows + '</tbody></table>'
