...
function main() {
  ...
  Logger.log(`Done. HTML files: ${htmlFiles.length}, JS files: ${jsFiles.length}, rows: ${rows.length}, missing server mapping: ${missing}`);
  Logger.log('Wrote: api_inventory.json, api_inventory.csv, api_inventory.md');
}
